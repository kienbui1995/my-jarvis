...
class User(Base):
    ...
    whatsapp_id: Mapped[str | None] = mapped_column(String(100), unique=True, index=True)
    slack_id: Mapped[str | None] = mapped_column(String(100), unique=True, index=True)
    discord_id: Mapped[str | None] = mapped_column(String(100), unique=True, index=True)
